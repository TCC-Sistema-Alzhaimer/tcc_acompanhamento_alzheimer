...
const NotificationList: React.FC<Props> = ({ notifications, onClose, refresh }) => {
    ...
    if (notifications.length === 0) {
        return <p className="p-4 text-sm text-gray-500 text-center">Nenhuma nova notificação</p>;
    }
